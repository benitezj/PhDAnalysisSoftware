...
// 	$Id: BPiD2starTagFilter.cc,v 1.4 2004/08/09 07:00:44 bartoldu Exp $
//
// Description:
...
// This Class's Header --
//-----------------------
#include "FilterTools/BPiD2starTagFilter.hh"
...
// Constructors --
//----------------
BPiD2starTagFilter::BPiD2starTagFilter( const char* const theName, 
...
// Destructor --
//--------------
BPiD2starTagFilter::~BPiD2starTagFilter()
{
}
...
AppResult
BPiD2starTagFilter::beginJob( AbsEvent*  anEvent )
{
...
AppResult 
BPiD2starTagFilter::event( AbsEvent* anEvent )
{
  _nReadEvents++;
...
AppResult
BPiD2starTagFilter::endJob( AbsEvent* anEvent ) {
