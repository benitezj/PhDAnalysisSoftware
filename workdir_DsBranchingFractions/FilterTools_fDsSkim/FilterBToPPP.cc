...
// Constructors --
//----------------
FilterBToPPP::FilterBToPPP( const char* const theName, 
...
AppResult
FilterBToPPP::beginJob( AbsEvent*  anEvent )
{
...
AppResult 
FilterBToPPP::event( AbsEvent* anEvent )
{
  _nReadEvents++;
  bool passed = false;
  setPassed( false );
...
AppResult
FilterBToPPP::endJob( AbsEvent* anEvent ) {
