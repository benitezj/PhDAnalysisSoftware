...
// 	$Id: InclOmegaFilter.hh,v 1.3 2000/11/07 01:18:37 jamesw Exp $
//
// Description:
...
#ifndef INCLOMEGAFILTER_HH
#define INCLOMEGAFILTER_HH
...
class InclOmegaFilter : public TagFilterModule {
...
public:
  ...
  // Constructors
  InclOmegaFilter( const char* const theName, 
	      const char* const theDescription );

  // Destructor
  virtual ~InclOmegaFilter();
