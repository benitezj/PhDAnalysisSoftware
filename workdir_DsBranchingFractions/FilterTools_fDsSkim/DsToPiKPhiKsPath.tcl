#
#  $Id: DsToPiKPhiKsPath.tcl,v 1.2 2008/11/29 21:31:37 rmwhite Exp $
#  Define the DsToPiKPhiKs path
#

path create DsToPiKPhiKsPath

set mySkimSequence DsToPiKPhiKsSequence
set myPhiList DsToPiKPhiKs_Phi

sequence create $mySkimSequence
path append DsToPiKPhiKsPath $mySkimSequence

# fwinkl: disabled persisting candidates in agreement with author
#global BtaCandLists
...
## phi cuts
##
set kaonListPhi1       "KCombinedSuperLoose"
set kaonListPhi2       "GoodTracksLoose"
set looseMassPhi       "Mass 0.98:1.06"

## Ds cuts
##
set pionListDs         "piCombinedSuperLoose"
set kaonListDs         "KCombinedSuperLoose"
...
mod clone FilterByList DsToPiKPhiKsFilter
path append DsToPiKPhiKsPath DsToPiKPhiKsFilter
talkto DsToPiKPhiKsFilter {
  orList set DsToPiPhi_Dsstar 
  orList set DsToPiKs_Dsstar 
  orList set DsToKPhi_Dsstar 
  orList set DsToKKs_Dsstar
}
