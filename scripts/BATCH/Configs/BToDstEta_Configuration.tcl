...
#--------------------------------------------------
module talk BToDstEta
    DstCandList set MyDstarCandList
    EtaList set etaggDefault
...
path append Everything BToDstEta
...
fillMC set false
    ...
    ntpBlockConfigs set "eta   Eta   2 20" 
    ...
    ntpBlockContents set "Eta: Mass Vertex VtxChi2 Momentum CMMomentum "
