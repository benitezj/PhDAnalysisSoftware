...
FwkCfgVar histFileName "DsTolnu/SP5315/Ntuples2/Ntuple1.root"
...
#--------------------------------------------------
source DsTolnu/SP5315/Ntuples2/DataSet-1.tcl
...
module talk RecoilTagInterface  
   ...
   #D_s, remove kaon:  DcToKsPi, DcToKKPi, DcToKsK, DcTopipipi
#    TagList4 set Dc3prongLoosePID
#    TagListMass4 set 1.9685
#    TagListMassCut4 set .02
#    TagListPstarCut4 set 2.5
...
module talk RecoilTagKaon
  ...
  KaonAngleCut set .1
exit
module talk RecoilDsLepton
  LeptonList set muNNVeryLoose
  LeptonEnergyCutLo set .2
  LeptonEnergyCutHi set 5.
  LeptonAngleCut set -.1
  LeptonType set muon
exit
...
module talk RecoilCheckCharge
  ...
  #D0
  #   Gam,Frag0(u ubar),Ds+(c sbar), K-(s ubar), D0(cbar u)
  ChargeConfig1 set 55645 
  #   Gam,Frag-(d ubar),Ds+(c sbar), K0(s dbar), D0(cbar u)
  ChargeConfig2 set 54655 
  
  #D+
  #  Gam,Frag0(u ubar),Ds+(c sbar), K0(s dbar), D-(cbar d)
  ChargeConfig3 set 55654
  #  Gam,Frag+(u dbar),Ds+(c sbar), K-(s ubar), D-(cbar d)
  ChargeConfig4 set 56644
...
talkto BtuTupleMaker {
    ...
    ntpBlockConfigs set "D_s+   Ds    2 100"  
    ...
    ntpBlockConfigs set "nu_mu  Nu    0 100" 
    ...
    ntpBlockContents set "Ds:   Mass Vertex VtxChi2 Momentum Flight FlightBS CMMomentum"
    ...
    ntpBlockContents set "Mu:   Momentum Doca Poca CMMomentum "
    ntpBlockContents set "E:    Momentum Doca Poca CMMomentum "
    ntpBlockContents set "Gam:  Momentum CMMomentum "
    ntpBlockContents set "Nu:   Mass Momentum CMMomentum "
    
    checkCloneBlocks set "K Pi Mu E Gam"
}
