...
FwkCfgVar histFileName "DsTolnu/SP5315/DsReco2/Ntuples1/Ntuple1.root"
...
#--------------------------------------------------
source DsTolnu/SP5315/DsReco2/Ntuples1/DataSet-1.tcl
...
module talk RecoilFragPions
    ...
    GamEnergyCutLo set .03
    GamEnergyCutHi set 1.
    FitFrag set false
    PionAngleCut set .1
    PionAngleCutSide set 1.
exit
...
module talk RecoilCheckCharge
  ...
  #missing particle is Ds+(c sbar) + Frag2(u ubar, d ubar, u dbar)
  #
  
  #--------------
  #D0
  #--------------
  #   Gam,Frag10(u ubar), K-(s ubar), D0(cbar u)
  ChargeConfig1 set 5545 
  #   Gam,Frag1-(d ubar), K0(s dbar), D0(cbar u)
  ChargeConfig2 set 5455 

  #   Gam,Frag1+(dbar u), K-(s ubar), D0(cbar u)
  ChargeConfig3 set 5645 
  #   Gam,Frag10(u ubar), K0(s dbar), D0(cbar u)
  ChargeConfig4 set 5555 

  
  #D+
  #  Gam,Frag10(u ubar), K0(s dbar), D-(cbar d)
  ChargeConfig5 set 5554
  #  Gam,Frag1+(u dbar), K-(s ubar), D-(cbar d)
  ChargeConfig6 set 5644

  #  Gam,Frag1+(u ubar), K0(s dbar), D-(cbar d)
  ChargeConfig7 set 5654
...
talkto BtuTupleMaker {
    ...
    ntpBlockConfigs set "B*+    Evt   3 100" 
    ntpBlockConfigs set "B*0    Evt   3 100" 
    ntpBlockConfigs set "B+     B     3 100"
    ntpBlockConfigs set "B0     B     3 100"
    ...
    ntpBlockContents set "B: Mass Vertex VtxChi2 Momentum CMMomentum nDaughters"
...
path append Everything RecoilDsEvtCandListFit2
