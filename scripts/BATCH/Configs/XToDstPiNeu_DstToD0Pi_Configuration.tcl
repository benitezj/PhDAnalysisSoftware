...
path append Everything XToDstPiNeu
...
fillMC set false
    ...
    ntpBlockContents set "Dstar : Mass Momentum CMMomentum"
    ntpBlockContents set "D0 :  Mass Momentum CMMomentum"
    ntpBlockContents set "Pi:  Momentum CMMomentum "
    ntpBlockContents set "K:  Momentum  CMMomentum "
    ntpBlockContents set "Trk: Mass Momentum CMMomentum "    
