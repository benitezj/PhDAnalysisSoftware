...
path append Everything BToDstGam
...
fillMC set false
    ...
    ntpBlockConfigs set "gamma Gam   0 20" 
    ...
    ntpBlockContents set "Dst: Mass Momentum CMMomentum "
    ntpBlockContents set "D:   Mass Momentum CMMomentum Flight "
