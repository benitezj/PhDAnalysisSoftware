...
Int_t BToDstPiAnalysis::FitMES(){
  ...
  TFile WSmESFile(_OutputDir+"/../mESWS/Ntuple.root","read");
  gROOT->cd();
  ...
  TH1F HWSmES("HWSmES","",40,5.20,5.30);
  ...
  //--------------------------------------------------------------------
  //Fit WS data with Argus function
  //--------------------------------------------------------------------
  Bkg.fitTo(HB,"m");
...
//   delete plot;
  ...
  //--------------------------------------------------------------------
  //Fit RS data with WS Histo + CBShape
  //--------------------------------------------------------------------
  ...
  RooRealVar sm0("sm0","sm0",5.27,5.29);//5.2794);
  RooRealVar sigma("sigma","sigma",.001,.005);//.003);
