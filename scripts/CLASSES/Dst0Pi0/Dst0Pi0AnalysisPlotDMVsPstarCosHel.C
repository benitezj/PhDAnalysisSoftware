...
Int_t Dst0Pi0Analysis::PlotDMVsPstarCosHel(){
  ...
  //Binning
  Float_t dmmin=database.GetDst0Pi0DeltaMRangeMin();
  Float_t dmmax=database.GetDst0Pi0DeltaMRangeMax();
  Int_t nbins=database.GetDst0Pi0DeltaMRangeNbins()/4;
