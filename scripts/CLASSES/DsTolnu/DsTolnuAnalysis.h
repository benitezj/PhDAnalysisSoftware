...
class DsTolnuAnalysis:public TagAnalysis{
 ...
 public:
  ...
  void SetReduceCuts(Int_t _cuttruth,Int_t _cutcharge,Int_t _cuttagmass,Int_t _cutlepangle,Int_t _cutgamangle,Int_t _cutKangle){
    cuttruth=_cuttruth;cutcharge=_cutcharge;cuttagmass=_cuttagmass;cutlepangle=_cutlepangle;cutgamangle=_cutgamangle;cutKangle=_cutKangle;
  }
 ...
 private:
  ...
  Int_t   nNu;
  Float_t Nup3[MAXNCANDS];    
  Float_t Nucosth[MAXNCANDS];
  Float_t Nuphi[MAXNCANDS];   
  Float_t Nuenergy[MAXNCANDS]; 
  Float_t Nup3CM[MAXNCANDS];  
  Float_t NucosthCM[MAXNCANDS];  
  Float_t NuphiCM[MAXNCANDS];  
  Float_t NuenergyCM[MAXNCANDS]; 
  Int_t   NuLund[MAXNCANDS];  
