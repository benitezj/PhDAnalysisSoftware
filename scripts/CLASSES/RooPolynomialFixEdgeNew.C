...
RooPolynomialFixEdgeNew::RooPolynomialFixEdgeNew(const char *name, const char *title,RooAbsReal& _x,
					   TH1*Histo,RooFormula* Yield,RooAbsReal& _c3,RooAbsReal& _c4,RooAbsReal& _c5,
...
Double_t RooPolynomialFixEdgeNew::evaluate() const
{
  ...
  //----------------------------
  Double_t Coef2=(
		  (delta*y1/yield->eval()-1.000)*diffx0 
		  -(delta*y0/yield->eval()-1.000)*diffx1		 
