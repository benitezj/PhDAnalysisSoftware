#------------------------------------------------------------------------------
# $Id: BtuMyAnalysis.tcl,v 1.1 2004/09/11 06:24:07 chcheng Exp $
...
seq disable CompKsProdSequence
...
talkto BtuTupleMaker {
    ...
    ntpBlockContents set "B0   : Mass CMMomentum Vertex VtxChi2 UsrData(B0ToD0KPi,myCandData) MCIdx"
    ...
    ntpBlockContents set "Pi   : Momentum DocaXY PocaXY PocaErr PocaCov"
